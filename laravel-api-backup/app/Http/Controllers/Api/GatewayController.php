...
class GatewayController extends Controller
{
    ...
    */
    private const DISPATCH_MAP = [
        ...
        'DeviceAction.store'   => [DeviceActionController::class, 'store'],   // any auth
        'DeviceAction.update'  => [DeviceActionController::class, 'update'],  // creator|admin
        'DeviceAction.destroy' => [DeviceActionController::class, 'destroy'], // creator|admin
        'DeviceAction.approve' => [DeviceActionController::class, 'approve'], // admin
        'DeviceAction.reject'  => [DeviceActionController::class, 'reject'],  // admin
