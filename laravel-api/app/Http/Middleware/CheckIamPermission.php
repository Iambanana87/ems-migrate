...
class CheckIamPermission
{
    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        $publicActions = [
            ...
            'Report.previewNextCodes',
            'DeviceAction.store',
            'DeviceAction.update',
            'DeviceAction.storeBackend',
            'DeviceAction.updateBackend',
            'DeviceAction.listByDevice',
            'DeviceAction.destroy',
            'DeviceAction.approve',
            'DeviceAction.reject',
            'DeviceAction.listV2',
            'DeviceAction.listActionPlans',
            'DeviceAction.previewNextCodes',
            'Report.countActions',
